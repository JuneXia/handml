...
datapath = '/home/yp/res/MNIST_data'
...
# 保存loss和测试准确率到csv文件
with open('AlexNet-input?x227x227x1-convBN?x55x55x96-maxpool?x27x27x96-convBN?x27x27x256-maxpool?x13x13x256-convBN?x13x13x384-convBN?x13x13x384-convBN?x13x13x256-maxpool?x6x6x256-fcBN?x4096-fcBN?x4096-output?x10-learnrate_1e-4-customInit_DefaultParam-epoch50.csv', 'w') as fid:

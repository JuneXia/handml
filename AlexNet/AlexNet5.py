...
# 保存loss和测试准确率到csv文件
with open('AlexNet-input?x227x227x1-conv?x55x55x96lrn-maxpool?x27x27x96-conv?x27x27x256lrn-maxpool?x13x13x256-conv?x13x13x384-group2conv?x13x13x384-group2conv?x13x13x256-maxpool?x6x6x256-fc?x4096-fc?x4096-output?x10-learnrate_1e-4-customInit-epoch50.csv', 'w') as fid:
...
'''
# AlexNet-input?x227x227x1-conv?x55x55x96lrn-maxpool?x27x27x96-conv?x27x27x256lrn-maxpool?x13x13x256-conv?x13x13x384-group2conv?x13x13x384-group2conv?x13x13x256-maxpool?x6x6x256-fc?x4096-fc?x4096-output?x10-learnrate_1e-4-customInit-epoch50.csv
AlexNet2-> conv4 conv5分组
